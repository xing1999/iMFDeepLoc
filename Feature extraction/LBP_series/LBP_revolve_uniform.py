...
if __name__ == '__main__':
    num_patterns = 36  # LBP值的模式种类
    grid_x = 1
    grid_y = 1
    normed = True
    image_folder = "E:\\Users\\zhangzhen\\Desktop\\Protein and subcellular segmentation\\data\\train_data\\Process_dataset\\protein"
    output_excel = "E:\\Users\\zhangzhen\\Desktop\\Protein and subcellular segmentation\\Feature_outcome\\train_data\\Feature_(LBP_revolve_uniform).xlsx"
